...
public class Build {
    ...
    private void build(MessageChannel message, Guild guild, String[] args, User user, MessageChannel channel,
        ...
        if (c1.equals("marché") || c1.equals("mar")) {
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 200 + (level_up - 25) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous devez etre niveau " + (200 + (level_up - 25) * 50)
                                + " pour ameliorer le marché .").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (200 + (level_up - 25) * 50) + " to upgrade the market .")
                                .queue();
                    }
                    return;
                }
                ...
                if (money >= need_money && paille >= need_paille && cuir >= need_cuir) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                ":up: Votre *marché* vient d'\u00eatre améliorée au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "\ud83d\udcb8 Vous n'avez pas assez d'argent. Pour cette amelioration, il vous faudrait **"
                                        + Utils.format(need_money) + "$** ainsi que " + Utils.format(need_cuir)
                                        + " cuir et " + Utils.format(need_paille) + " paille")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                        message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, You need **"
                                + Utils.format(need_money) + "$**, " + Utils.format(need_cuir) + " leather and "
                                + Utils.format(need_paille) + " straw").queue();
                    }
                }
            } else {
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre *marché* au niveau **" + level_up + "** pour **"
                            + Utils.format(need_money) + "$** ainsi que " + Utils.format(need_cuir) + " cuir et "
                            + Utils.format(need_paille) + " paille").queue();
                }
                if (lang == command.Language.en) {
                    message.sendMessage("Vous pouvez améliorer votre *market* au niveau **" + level_up + "** pour **"
                            + Utils.format(need_money) + "$** ainsi que " + Utils.format(need_cuir) + " leather et "
                            + Utils.format(need_paille) + " straw").queue();
                }
            }
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 150 + (level_up - 20) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous devez etre niveau " + (150 + (level_up - 20) * 50)
                                + " pour ameliorer le cirque .").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (150 + (level_up - 20) * 50) + " to upgrade the circus.")
                                .queue();
                    }
                    return;
                }
                if (money >= need_money) {
                    money -= need_money;
                    if (lang == command.Language.fr) {
                        message.sendMessage("Votre *cirque* vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "\ud83d\udcb8 Vous n'avez pas assez d'argent. Pour cette amelioration, il vous faudrait **"
                                        + Utils.format(need_money) + "$**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                        message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, you need **"
                                + Utils.format(need_money) + "$**").queue();
                    }
                }
            } else {
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre *Cirque* au niveau **" + level_up + "** pour **"
                            + Utils.format(need_money) + "$**").queue();
                }
                if (lang == command.Language.en) {
                    message.sendMessage("You can upgrade your *Circus* to level **" + level_up + "** for **"
                            + Utils.format(need_money) + "$**").queue();
                }
            }
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 300 + (level_up - 20) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous devez etre niveau " + (300 + (level_up - 20) * 50)
                                + " pour ameliorer l'armurerie.").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (300 + (level_up - 20) * 50) + " to upgrade your armory .")
                                .queue();
                    }
                    return;
                }
                if (money >= need_money) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "Votre *armurerie* vient d'\u00eatre amelioré au niveau **" + level_up + "**").queue();
                    }
                    if (lang == command.Language.en) {
                ...
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre *armurerie* au niveau **" + level_up + "** pour **"
                            + Utils.format(need_money) + "$**").queue();
                }
                if (lang == command.Language.en) {
                    message.sendMessage("You can upgrade your *armory* to level **" + level_up + "** for **"
                            + Utils.format(need_money) + "$**").queue();
                }
            }
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 150 + (level_up - 25) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous devez etre niveau " + (150 + (level_up - 25) * 50)
                                + " pour ameliorer vos habitations .").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (150 + (level_up - 25) * 50) + " to upgrade your residentials.")
                                .queue();
                    }
                    return;
                }
                if (money >= need_money && iron >= need_iron && bois >= need_bois) {
                    ...
                    if (lang == command.Language.en) {
                        message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, you need **"
                                + Utils.format(need_money) + "$**, " + Utils.format(need_bois) + " wood and "
                                + need_iron + " iron.").queue();
                    }
                }
            } else {
                if (lang == command.Language.fr) {
                ...
                if (lang == command.Language.en) {
                    message.sendMessage("You can upgrade your *residetials* to level **" + level_up + "** for **"
                            + Utils.format(need_money) + "$**, " + Utils.format(need_bois) + " wood and " + need_iron
                            + " iron.").queue();
                }
            }
            ...
            if (money >= (long) need_money && bois >= need_mat && cuir >= need_mat && iron >= need_mat
                ...
                paille -= need_mat;
                if (lang == command.Language.fr) {
                    message.sendMessage("Votre eglise vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                            .queue();
                }
                if (lang == command.Language.en) {
                ...
                if (lang == command.Language.en) {
                    message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, you need **"
                            + Utils.format(need_money) + "$** and " + Utils.format(need_mat) + " of every materials")
                            .queue();
                }
            }
            ...
            int need_mat = 50000;
            if (money >= need_money && bois >= need_mat && cuir >= need_mat && iron >= need_mat && argile >= need_mat
                    && paille >= need_mat && pierre >= need_mat) {
                money -= need_money;
                bois -= need_mat;
                iron -= need_mat;
                cuir -= need_mat;
                ...
                if (lang == command.Language.en) {
                    message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, you need **"
                            ...
                            + " of wood, leather and iron").queue();
                }
            }
            ...
            if (money >= (long) need_money && bois >= need_mat && cuir >= need_mat && iron >= need_mat
                ...
                paille -= need_mat;
                if (lang == command.Language.fr) {
                    message.sendMessage("Votre forge vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                            .queue();
                }
                if (lang == command.Language.en) {
                ...
                if (lang == command.Language.en) {
                    message.sendMessage("\ud83d\udcb8You don't have enough money. For this upgrade, you need **"
                            + Utils.format(need_money) + "$** and " + Utils.format(need_mat) + "de chaque materiaux")
                            .queue();
                }
            }
            ...
            if (c2 == level + 1) {
                if (money >= (long) need_money && bois >= need_mat && cuir >= need_mat && iron >= need_mat
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "Votre biblioth\u00e8que vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.en) {
                        message.sendMessage("\ud83d\udcb8You don't have enough money. For this upgrade, you need **"
                                + Utils.format(need_money) + "$** and " + Utils.format(need_mat)
                                + " of every materials").queue();
                    }
                }
            } else {
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre biblioth\u00e8que au niveau **" + level_up
                            + "** pour **" + Utils.format(need_money) + "$** ainsi que " + Utils.format(need_mat)
                            + "de chaque materiaux").queue();
                }
                if (lang == command.Language.en) {
                    message.sendMessage("You can upgrade you library to level **" + level_up + "** for **"
                            + Utils.format(need_money) + "$** and " + Utils.format(need_mat) + " of every materials")
                            .queue();
                }
            }
            ...
            if (c2 == level + 1) {
                ...
                if (money >= (long) need_money && bois >= need_bois && cuir >= need_cuir && iron >= need_iron) {
                    ...
                    cuir -= need_cuir;
                    if (lang == command.Language.fr) {
                        message.sendMessage("Votre camp vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.en) {
                        message.sendMessage("\ud83d\udcb8 You don't have enough money. For this upgrade, you need **"
                                + Utils.format(need_money) + "$**, " + Utils.format(need_bois) + " wood, "
                                + Utils.format(need_cuir) + " leather and " + need_iron + " iron.").queue();
                    }
                }
            } else {
                if (lang == command.Language.fr) {
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 300 + (level_up - 20) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage(
                                "Vous devez etre niveau " + (300 + (level_up - 20) * 50) + " pour ameliorer la mine .")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (300 + (level_up - 20) * 50) + " to upgrade your mine .")
                                .queue();
                    }
                    return;
                }
                ...
                if (money >= need_money && bois >= need_mat && argile >= need_mat && pierre >= need_mat
                    ...
                    iron -= need_mat;
                    if (lang == command.Language.fr) {
                        message.sendMessage("Votre *mine* vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                ...
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre *mine* au niveau **" + level_up + "** pour **"
                            + Utils.format(need_money) + "$**ainsi que " + Utils.format(need_mat)
                            + " de chaque materiau.").queue();
                }
                if (lang == command.Language.en) {
                    message.sendMessage("You can upgrade your *mine* to level **" + level_up + "** for **"
                            + Utils.format(need_money) + "$** and " + Utils.format(need_mat) + " of every materials.")
                            .queue();
                }
            }
            ...
            if (c2 == level + 1) {
                ...
                if (money >= need_money && argile >= need_mat && pierre >= need_mat && paille >= need_mat) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "Votre *muraille* vient d'\u00eatre amelioré au niveau **" + level_up + "**").queue();
                    }
                    if (lang == command.Language.en) {
            ...
            if (c2 == level + 1) {
                ...
                if (Glevel < 250 + (level_up - 20) * 50) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous devez etre niveau " + (250 + (level_up - 20) * 50)
                                + " pour ameliorer le tour de sorcier .").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage(
                                "You must be level " + (250 + (level_up - 20) * 50) + " to upgrade your wizard tower.")
                                .queue();
                    }
                    return;
                }
                ...
                if (money >= need_money && argile >= need_mat && pierre >= need_mat && paille >= need_mat) {
                    ...
                    if (lang == command.Language.fr) {
                        message.sendMessage(
                                "Votre *tour de sorcier* vient d'\u00eatre amelioré au niveau **" + level_up + "**")
                                .queue();
                    }
                    if (lang == command.Language.en) {
                ...
                if (lang == command.Language.fr) {
                    message.sendMessage("Vous pouvez améliorer votre *tour de sorcier* au niveau **" + level_up
                            + "** pour **" + Utils.format(need_money) + "$**ainsi que " + Utils.format(need_mat)
            ...
            if (level + 1 == 1 && !c3.equals("gare")) {
                ...
                if (lang == command.Language.en) {
                    channel.sendMessage("You can actually build your gare for  50.000.000$ and 500 of every materials.")
                            .queue();
                }
                return;
            }
            ...
            if (level + 1 == 3 && !c3.equals("aeroport")) {
                ...
                if (lang == command.Language.en) {
                    channel.sendMessage(
                            "You can actually build your aeroport for 400.000.000$ and 2500 of every materials.")
                            .queue();
                }
                return;
            }
