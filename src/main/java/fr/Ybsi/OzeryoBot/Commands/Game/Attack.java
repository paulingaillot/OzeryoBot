...
public class Attack {
    ...
    public static void Attack(Profil user, Profil cible, int atk, String hero) {
            try {
                ...
                try {
                    trophéescible = cible.getTrophy();
                } catch (NullPointerException e1) {
                    trophéescible = 0;
                }
                try {
                    trophéesuser = user.getTrophy();
                } catch (NullPointerException e1) {
                    trophéesuser = 0;
                }
    ...
    public static void Attack2(Profil user, String cible2, int atk, ProfilData data, String hero) {
        block117:
        {
            try {
                boolean Umail;
                ...
                e.printStackTrace();
                CommandMap.Log("Attack point de ravitaillement", e.getLocalizedMessage(), DiscordBot.getjda());
            }
        }
    }

    public static void AttackDungeon(Profil user, String cibleId, JDA jda) {
        block52:
        {
            try {
    ...
    private void attack(Message message, Guild guild, String[] args, User user, MessageChannel channel, String arg,
        ...
        if (cible == null) {
            ...
            long ATKmax = habitants.atk(data.getProfils().get(user.getId()));
            if ((long) atk > ATKmax) {
                if (lang == command.Language.fr) {
