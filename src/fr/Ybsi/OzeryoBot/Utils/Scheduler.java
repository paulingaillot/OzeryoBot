                    ...
                    if (jda.getStatus() == JDA.Status.CONNECTED) {
                        ...
                        for (GuildProfil profil : DiscordBot.getGuilddata().getGuildProfil().values()) {
                            try {
                                ...
                                CommandMap.PublicLog("\ud83d\udfe0 OzeryoBot a été retiré du serveur " + profil.getName() + ".", jda);
        ...
        Runnable Uptime_Update = new Runnable(){
            ...
            public void run() {
                try {
                    ...
                    for (GuildProfil profil : DiscordBot.getGuilddata().getGuildProfil().values()) {
                        try {
                            if (DiscordBot.getGuilddata().getGuildProfil().get(profil.getId()).getPubchannel().equals("")) continue;
                            for (int i = 0; i < jda.getGuildById(profil.getId()).getTextChannelById(DiscordBot.getGuilddata().getGuildProfil().get(profil.getId()).getPubchannel()).getMembers().size(); ++i) {
                                list.add(profil.getId());
                            }
                        }
                        catch (Exception i) {
                    ...
                    for (GuildProfil profil : DiscordBot.getGuilddata().getGuildProfil().values()) {
                        try {
                            ...
                            DiscordBot.getGuilddata().getGuildProfil().get(id).setPub_sent(DiscordBot.getGuilddata().getGuildProfil().get(id).getPub_sent() + 1);
                            ChannelManager channel = jda.getGuildById(DiscordBot.getGuilddata().getGuildProfil().get(id).getId()).getTextChannelById(DiscordBot.getGuilddata().getGuildProfil().get(id).getPubchannel()).getManager();
                            if (jda.getGuildById(id).getSelfMember().hasPermission(Permission.MANAGE_CHANNEL)) {
                                channel.setTopic("Puclicité : Pub envoyé : " + DiscordBot.getGuilddata().getGuildProfil().get(id).getPub_sent() + " | Pub liké : 0 | Pub rapporté : 0").queue();
                            }
                            jda.getGuildById(DiscordBot.getGuilddata().getGuildProfil().get(profil.getId()).getId()).getTextChannelById(DiscordBot.getGuilddata().getGuildProfil().get(profil.getId()).getPubchannel()).sendMessage(pub).queue();
            ...
            public void run() {
                try {
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        String rank = o == 1 ? "\ud83e\udd47" : (o == 2 ? "\ud83e\udd48" : (o == 3 ? "\ud83e\udd49" : String.valueOf(o) + "\u00e8me"));
                        String user3;
                        try {
                        ...
                        messages = String.valueOf(messages) + "<span style=\"font-weight : bold\">" + rank + "</span> : " + (String)user3 + " : " + entry.getValue() + "\n";
                        ++o;
                    }
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/top.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/top.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        String member2 = "Une personne discr\u00e8te | <span style=\"font-weight : bold\">Level</span> : " + level + emoji + " | <span style=\"font-weight : bold\">Level</span>EXP</span> ";
                        try {
                            member2 = String.valueOf(jda.getUserById((String)entry.getKey()).getName()) + " | <span style=\"font-weight : bold\">Level</span> : " + level + emoji + " | <span style=\"font-weight : bold\">EXP</span> ";
                        }
                        catch (NullPointerException math) {
                            // empty catch block
                        }
                        messages = String.valueOf(messages) + "<span style=\"font-weight : bold\">" + rank + "</span> : " + (String)member2 + " : " + entry.getValue() + "\n";
                        ++o;
                    }
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/gamelevel.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/gamelevel.txt", String.valueOf(classement.size()), 0);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/gamelevel.txt", messages, 1);
                    classement = new HashMap();
                    for (Profil profil : data.getProfils().values()) {
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        try {
                            member = String.valueOf(jda.getUserById((String)entry.getKey()).getName()) + " | <span style=\"font-weight : bold\">réputation</span>";
                        }
                        catch (NullPointerException level) {
                            // empty catch block
                        }
                        messages = String.valueOf(messages) + "<span style=\"font-weight : bold\">" + rank + "</span> : " + (String)member + " : " + entry.getValue() + "\n";
                        ++o;
                    }
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/rep.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/rep.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        try {
                            member = String.valueOf(jda.getUserById((String)entry.getKey()).getName()) + " | <span style=\"font-weight : bold\">Combo</span>  ";
                        }
                        catch (NullPointerException level) {
                            // empty catch block
                        }
                    ...
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/cf.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        member = "Une personne discr\u00e8te | <span style=\"font-weight : bold\">Rank</span> : " + rank1 + " | <span style=\"font-weight : bold\">Trophées</span>  ";
                        try {
                            member = String.valueOf(jda.getUserById((String)entry.getKey()).getName()) + " | <span style=\"font-weight : bold\">Rank</span> : " + rank + " | <span style=\"font-weight : bold\">Trophées</span>  ";
                        }
                    ...
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/trophées.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (GuildProfil guildProfil : DiscordBot.getGuilddata().getGuildProfil().values()) {
                        try {
                            ...
                            String member3 = String.valueOf(Guildname) + " | <span style=\"font-weight : bold\">Level</span> : " + level;
                    ...
                    for (Map.Entry entry : entries) {
                        String rank = o == 1 ? "\ud83e\udd47" : (o == 2 ? "\ud83e\udd48" : (o == 3 ? "\ud83e\udd49" : String.valueOf(o) + "\u00e8me"));
                        messages = String.valueOf(messages) + "<span style=\"font-weight : bold\">" + rank + "</span> : " + (String)entry.getKey() + " : " + entry.getValue() + "\n";
                        ++o;
                    }
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/guild.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/guild.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        member4 = String.valueOf(member4) + "| <span style=\"font-weight : bold\">Level</span> : " + Level.level((String)entry.getKey()) + " | <span style=\"font-weight : bold\">EXP</span> : ";
                        messages = String.valueOf(messages) + "<span style=\"font-weight : bold\">" + (String)rank5 + "</span> : " + member4 + " : " + entry.getValue() + "\n";
                        ++o;
                    }
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/level.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/level.txt", String.valueOf(classement.size()), 0);
                    ...
                    for (File file : files) {
                        try {
                            ...
                            String member5 = String.valueOf(file.getName()) + " | <span style=\"font-weight : bold\">Level</span> : " + level;
                    ...
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/pays.txt", String.valueOf(classement.size()), 0);
                    ...
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/LeaderBoard/ap.txt", String.valueOf(classement.size()), 0);
...
g1.dispose();
try {
    ImageIO.write((RenderedImage)image, "png", new File("/home/DiscordBot/Rasberry/données/bot/WebMap/"+x+"_"+y+".png"));
}
catch (Exception ex) {
    ex.printStackTrace();
}
                ...
                try {
                    ...
                    block26 : {
                        ...
                        try {
                            ...
                            if (player == "d140036beb824390a01be4995da5f6a5") break block26;
                            e1.printStackTrace();
                        }
                    }
                    try {
                        for (int i = 0; i < jsonObject.getAsJsonArray("records").size() - 1; ++i) {
                            ...
                            if (!jsonObject.getAsJsonArray("records").get(i).getAsJsonObject().get("uuidReceiver").toString().replaceAll("\"", "").equals(player) && inQueue) {
                                HypixelQueue.add(jsonObject.getAsJsonArray("records").get(i).getAsJsonObject().get("uuidReceiver").toString().replaceAll("\"", ""));
                            }
                            if (jsonObject.getAsJsonArray("records").get(i).getAsJsonObject().get("uuidSender").toString().replaceAll("\"", "").equals(player) || !inQueue) continue;
                            HypixelQueue.add(jsonObject.getAsJsonArray("records").get(i).getAsJsonObject().get("uuidSender").toString().replaceAll("\"", ""));
                        }
                    }
                    ...
                    for (Map.Entry entry : entries) {
                        ...
                        if (!((String)entry.getKey()).equals(player)) continue;
                        legacyRank = o;
                        bool = true;
                    }
                    ...
                    String xp3;
                    try {
                         xp3 = jsonObject.getAsJsonObject("player").getAsJsonObject("stats").getAsJsonObject("Pit").getAsJsonObject("profile").get("xp").toString().replace("\"", "");
                    }
                    catch (Exception e) {
                         xp3 = "0";
                    }
        ...
        Runnable Uptime_Update = new Runnable(){
            ...
            public void run() {
                if (jda.getPing() < 1000L) {
                    long uptime = Long.parseLong(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/uptime.txt"));
                    TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/uptime.txt");
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/uptime.txt", Long.toString(uptime += 60000L), 1);
                    ...
                    jda.getGuildById("326345972739473410").getVoiceChannelById("549589565405528084").getManager().setName("Uptime : " + pourcent2 + "%").queue();
                } else {
                    long uptime = Long.parseLong(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/uptime.txt"));
                    double total = System.currentTimeMillis() - 1558450050583L;
                    double operation = 100.0 / total;
                ...
                block47 : {
                    try {
                        ...
                        for (x = -10; x <= 10; ++x) {
                            for (y = -10; y <= 10; ++y) {
                                try {
                                    ...
                                    if (!name.equals("Foret") && !name.equals("Grotte") && !name.equals("Dép\u00f4t d'Argile") && !name.equals("Bétail") && !name.equals("Carri\u00e8re") && !name.equals("Champs") && !name.equals("Mine")) continue;
                                    ++res;
                                    continue;
                                }
                        ...
                        if (res < 25) {
                            ...
                            TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/name.txt", type, 1);
                            int alea2 = 0;
                            alea2 = !type.equals("Grotte") ? 1000 + (int)(Math.random() * 6001.0) : 100 + (int)(Math.random() * 601.0);
                            TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/res.txt", String.valueOf(alea2), 1);
                            CommandMap.PublicLog(":camping: Un nouveau point de ressourece est apparu en " + x + " " + y + ".", DiscordBot.getjda());
                        }
                        ...
                        for (x = -10; x <= 10; ++x) {
                            for (y = -10; y <= 10; ++y) {
                                try {
                                    name = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/name.txt");
                                    if (!name.equals("dungeon")) continue;
                                    ++donjon;
                                    continue;
                                }
                                catch (IllegalArgumentException e1) {
                        ...
                        TextFileWriter.folder("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y);
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/name.txt", "dungeon", 1);
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/bosslevel.txt", String.valueOf(level), 1);
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/atk.txt", String.valueOf(atk), 1);
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/pv.txt", String.valueOf(pv), 1);
                        CommandMap.PublicLog(":skull_crossbones: Un nouveau donjon est apparu en " + x + " " + y + ".", DiscordBot.getjda());
                    }
                    catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public static void Help(final String id, final TextChannel channel, final Guild guild, final CommandMap commandMap) {
        Runnable Help_Update = new Runnable(){
                        ...
                        for (User user : emoji.getUsers()) {
                            ...
                            if (emote.equals("\ud83d\udc51")) {
                                ...
                                for (SimpleCommand command2 : commandMap.getCommands()) {
                                    if (command2.getExecutorType() == command.ExecutorType.CONSOLE || command2.getTopic() != command.Topics.Admin) continue;
                            ...
                            if (emote.equals("\ud83c\udfae")) {
                                ...
                                for (SimpleCommand command3 : commandMap.getCommands()) {
                                    if (command3.getExecutorType() == command.ExecutorType.CONSOLE || game.contains(command3.getName()) || command3.getTopic() != command.Topics.Game) continue;
                            ...
                            if (emote.equals("\ud83c\udfb5")) {
                                ...
                                for (SimpleCommand command4 : commandMap.getCommands()) {
                                    if (command4.getExecutorType() == command.ExecutorType.CONSOLE || command4.getTopic() != command.Topics.Music) continue;
                            ...
                            if (emote.equals("\ud83d\udd25")) {
                                ...
                                for (SimpleCommand command5 : commandMap.getCommands()) {
                                    if (command5.getExecutorType() == command.ExecutorType.CONSOLE || command5.getTopic() != command.Topics.Social) continue;
                            ...
                            if (emote.equals("\u26a1")) {
                                ...
                                for (SimpleCommand command6 : commandMap.getCommands()) {
                                    if (command6.getExecutorType() == command.ExecutorType.CONSOLE || command6.getTopic() != command.Topics.Util) continue;
                            ...
                            if (emote.equals("\ud83e\udd84")) {
                                ...
                                for (SimpleCommand command7 : commandMap.getCommands()) {
                                    if (command7.getExecutorType() == command.ExecutorType.CONSOLE || command7.getTopic() != command.Topics.Stories) continue;
                            ...
                            for (SimpleCommand command8 : commandMap.getCommands()) {
                                if (command8.getExecutorType() == command.ExecutorType.CONSOLE) continue;
                                ...
                                if (command8.getTopic() != command.Topics.Stories) continue;
            ...
            public void run() {
                ...
                for (x = -10; x <= 10; ++x) {
                    for (y = -10; y <= 10; ++y) {
                        ...
                        int soldiers = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/soldier.txt"));
                        String user = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/owner.txt");
                        int xp = data.getProfils().get(user).getXp();
                        int perte = xp * 1000;
                        if ((soldiers = (int)((double)soldiers * 0.99)) < 1) {
                            soldiers = 1;
                        }
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/soldier.txt", Integer.toString(soldiers), 1);
                    }
                }
            }
        };
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        TextFileWriter.recursifDelete(new File("/home/DiscordBot/Rasberry/données/backup/" + day + "-" + mois + "-" + année));
                    }
                ...
                try {
                    ...
                    for (File file : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/données/bot/Pays")) {
                        for (int i = 1; i <= 10; ++i) {
                            ...
                            String machine = TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/machine/machine" + i + ".txt");
                            if (machine.equals("active")) {
                                lastpay = Long.parseLong(TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/machine/lastpay" + i + ".txt"));
                                if (System.currentTimeMillis() - lastpay <= 3600000L) continue;
                                long money = Long.parseLong(TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/bank.txt"));
                                long cout = Long.parseLong(TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/machine/cout" + i + ".txt"));
                                if (cout < 100000L) {
                                    cout = 100000L;
                                }
                                if (cout > money) {
                                    TextFileWriter.write(String.valueOf(file.getAbsolutePath()) + "/machine/machine" + i + ".txt", "stop", 1);
                                    continue;
                                }
                                TextFileWriter.write(String.valueOf(file.getAbsolutePath()) + "/bank.txt", Long.toString(money -= cout), 1);
                                TextFileWriter.write(String.valueOf(file.getAbsolutePath()) + "/machine/lastpay" + i + ".txt", Long.toString(System.currentTimeMillis()), 1);
                                cout = (long)((double)cout * 1.1);
                                TextFileWriter.write(String.valueOf(file.getAbsolutePath()) + "/machine/cout" + i + ".txt", Long.toString(cout), 1);
                                continue;
                            }
                            if (!machine.equals("stop")) continue;
                            lastpay = Long.parseLong(TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/machine/lastpay" + i + ".txt"));
                            if (System.currentTimeMillis() - lastpay <= 3600000L) continue;
                            long cout = Long.parseLong(TextFileWriter.read(String.valueOf(file.getAbsolutePath()) + "/machine/cout" + i + ".txt"));
                            ...
                            try {
                                for (ArrayList test : map.values()) {
                                    ...
                                    try {
                                        ...
                                        String name = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + cibleId + "/name.txt");
                                        ...
                                        if (name.equals("personne")) {
                                            ...
                                            if (!Umail) {
                                                ...
                                                if (lang == command.Language.fr) {
                                                    ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Rapport d'Attaque de donjon :crossed_swords: \n Votre hero est arrivé trop tard, un joueur a deja vaincu le donjon.").queue();
                                                }
                                                if (lang != command.Language.en) continue;
                                                ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Dungeon attack report :crossed_swords: \n Your hero arrived too late and another person killed the boss.").queue();
                                                continue;
                                            }
                                            ...
                                            if (lang == command.Language.fr) {
                                                mail1.add(":crossed_swords: Rapport d'Attaque de donjon :crossed_swords: \\n Votre hero est arrivé trop tard, un joueur a deja vaincu le donjon.");
                                            }
                                            if (lang == command.Language.en) {
                                                mail1.add(":crossed_swords: Dungeon attack report :crossed_swords: \n Your hero arrived too late and another person killed the boss.");
                                            }
                                            mail1.add("false");
                        ...
                        try {
                            try {
                                for (ArrayList test : map1.values()) {
                                    ...
                                    ((UserImpl)user).getPrivateChannel().sendMessage(String.valueOf(user.getAsMention()) + " | Remind : " + messages).queue();
                                }
                            }
                            catch (ConcurrentModificationException test) {
                                // empty catch block
    ...
    public static void Ressources(final JDA jda) {
            ...
            public void run() {
                block40 : {
                    try {
                        ...
                        if (hour == LastRessourcesDate || minutes <= 0 || minutes >= 5) break block40;
                        ProfilData data = DiscordBot.getData();
                        ...
                        for (x = -10; x <= 10; ++x) {
                            for (y = -10; y <= 10; ++y) {
                                int res1;
                                String owner = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/owner.txt");
                                String name = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/name.txt");
                                if (!name.equals("Foret") && !name.equals("Dép\u00f4t d'Argile") && !name.equals("Bétail") && !name.equals("Carri\u00e8re") && !name.equals("Champs") && !name.equals("Mine") && !name.equals("Grotte") || owner.equals("personne")) continue;
                                try {
                                    res1 = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/res.txt"));
                                }
                                catch (NumberFormatException e) {
                                    res1 = 0;
                                }
                                ...
                                if (res1 > 0) {
                                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y + "/res.txt", Integer.toString(res1), 1);
                                }
                                if (res1 <= 0) {
                                    TextFileWriter.recursifDelete(new File("/home/DiscordBot/Rasberry/données/bot/Map/" + x + "_" + y));
                                }
                        ...
                        CommandMap.PublicLog(String.valueOf(emoji.getAsMention()) + " Les joueurs present sur les zones de ressources ont recus leur butin.", jda);
                    }
                    catch (Exception e) {
                        e.printStackTrace();
        ...
        ScheduledFuture<?> RessourcesHandle = scheduler1.scheduleAtFixedRate(Ressources_Update, 2L, 1L, TimeUnit.MINUTES);
    }
        ...
        Runnable Bid_Update = new Runnable(){
            ...
            public void run() {
                ...
                if (day != LastBidDate && hour == 0) {
                    ...
                    try {
                        int bidjetons = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Bid/bidjetons.txt"));
                    }
                    catch (NumberFormatException e) {
                    ...
                    if (object2.equals("pet")) {
                        ...
                        if ((Integer)building.get("cirque") >= pets) {
                            ...
                            try {
                                Parieur = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/Users/" + user.getId() + "/Achievement/Parieur.txt"));
                            }
                            catch (NumberFormatException e) {
                                Parieur = 0;
                            }
                            TextFileWriter.write("/home/DiscordBot/Rasberry/données/Users/" + user.getId() + "/Achievement/Parieur.txt", Integer.toString(++Parieur), 1);
                            if (!user.hasPrivateChannel()) {
                                user.openPrivateChannel().complete();
                            }
                            ((UserImpl)user).getPrivateChannel().sendMessage("Vous venez de gagner un pet nommé " + object + " dans les encheres.").queue();
                        } else {
                            if (!user.hasPrivateChannel()) {
                                user.openPrivateChannel().complete();
                            }
                            ((UserImpl)user).getPrivateChannel().sendMessage("Vous venez de gagner les encehres mais votre zoo est pleins ... vous avez donc perdu votre lot.").queue();
                        }
                        ...
                        ((UserImpl)user).getPrivateChannel().sendMessage("Vous venez de gagner une habitation nommé " + object + " dans les encheres.").queue();
                        ...
                        weapon = TextFileWriter.read(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Bid/bid.txt"));
                        ...
                        if (LootBox.test(user) <= building.get("armurerie") * 5 + 20) {
                            ...
                            ((UserImpl)user).getPrivateChannel().sendMessage("Vous venez de gagner une arme nommé " + object + " de niveau " + level + " dans les encheres.").queue();
                        } else {
                            if (!user.hasPrivateChannel()) {
                                user.openPrivateChannel().complete();
                            }
                            ((UserImpl)user).getPrivateChannel().sendMessage("Oh non, Vous auriez pu gagner une arme nommé " + object + " de niveau " + level + " dans les encheres mais votre entrepot est plein.").queue();
                        }
                    } else if (object2.equals("armor")) {
                        HashMap<String, Integer> building = data.getProfils().get(user.getId()).getBuilding();
                        HashMap<String, ArrayList<Integer>> armors = data.getProfils().get(user.getId()).getArmor();
                        armor = TextFileWriter.read(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Bid/bid.txt"));
                        int level = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Bid/level.txt"));
                        if (LootBox.test(user) <= building.get("armurerie") * 5 + 20) {
                            ...
                            ((UserImpl)user).getPrivateChannel().sendMessage("Vous venez de gagner une armure nommé " + object + " de niveau " + level + " dans les encheres.").queue();
                        } else {
                            if (!user.hasPrivateChannel()) {
                                user.openPrivateChannel().complete();
                            }
                            ((UserImpl)user).getPrivateChannel().sendMessage("Oh non, Vous auriez pu gagner une armure nommé " + object + " de niveau " + level + " dans les encheres mais votre entrepot est plein.").queue();
                        }
                    }
                    CommandMap.PublicLog(":scales: L'objet " + object + " a été remporté par " + user.getName() + " dans l'ench\u00e8re aujourd'hui", jda);
                    ...
                    if (aleabid == 1 || aleabid == 2) {
                        int objects = TextFileWriter.folderlength("/home/DiscordBot/Rasberry/données/bot/Bid/" + object2);
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Bid/level.txt", "" + aleaWeapon2, 1);
    ...
    public static void Shop() {
        Runnable Shop_Update = new Runnable(){
            ...
            public void run() {
                try {
                    int bois = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/bois.txt"));
                    int argile = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/argile.txt"));
                    int cuir = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/cuir.txt"));
                    int pierre = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/pierre.txt"));
                    int paille = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/paille.txt"));
                    int fer = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/fer.txt"));
                    int alea = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Shop/alea.txt"));
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/bois.txt", Integer.toString(++bois), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/argile.txt", Integer.toString(++argile), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/cuir.txt", Integer.toString(++cuir), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/pierre.txt", Integer.toString(++pierre), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/paille.txt", Integer.toString(++paille), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/fer.txt", Integer.toString(++fer), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Shop/alea.txt", Integer.toString(++alea), 1);
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public static void File_Delete(int durée, TimeUnit timeunit, final String file) {
        ...
        final ScheduledFuture<?> File_DeleteHandle = scheduler1.scheduleAtFixedRate(File_Delete_Update, durée, durée, timeunit);
        ...
        Runnable Guild_Bonus_Update = new Runnable(){
            ...
            public void run() {
                ...
                if (day != LastQuestDate && hour == 0) {
                    String lastquest1;
                    LastQuestDate = day;
                    String quest1 = lastquest1 = TextFileWriter.read("/home/DiscordBot/Rasberry/données/bot/Quests/quest1.txt");
                    while (lastquest1.equals(quest1)) {
                        int alea1 = 1 + (int)(Math.random() * 18.0);
                        quest1 = alea1 == 1 ? "tr" : (alea1 == 2 ? "hr" : (alea1 == 3 ? "mana" : (alea1 == 4 ? "atk" : (alea1 == 5 ? "def" : (alea1 == 6 ? "exp" : (alea1 == 7 ? "invest" : (alea1 == 8 ? "vote" : (alea1 == 9 ? "shop" : (alea1 == 10 ? "soldier" : (alea1 == 11 ? "jetons" : (alea1 == 12 ? "materiau" : (alea1 == 13 ? "bois" : (alea1 == 14 ? "acier" : (alea1 == 15 ? "brique" : (alea1 == 16 ? "verre" : (alea1 == 17 ? "pierre" : (alea1 == 18 ? "petrole" : "tr")))))))))))))))));
                    }
                    ...
                    while (quest2.equals(quest1) || quest2.equals(lastquest2)) {
                        ...
                        quest2 = alea2 == 1 ? "tr" : (alea2 == 2 ? "hr" : (alea2 == 3 ? "mana" : (alea2 == 4 ? "atk" : (alea2 == 5 ? "def" : (alea2 == 6 ? "exp" : (alea2 == 7 ? "invest" : (alea2 == 8 ? "vote" : (alea2 == 9 ? "shop" : (alea2 == 10 ? "soldier" : (alea2 == 11 ? "jetons" : (alea2 == 12 ? "materiau" : (alea2 == 13 ? "bois" : (alea2 == 14 ? "acier" : (alea2 == 15 ? "brique" : (alea2 == 16 ? "verre" : (alea2 == 17 ? "pierre" : (alea2 == 18 ? "petrole" : "tr")))))))))))))))));
                    }
                    ...
                    while (quest3.equals(quest1) || quest3.equals(quest2) || quest3.equals(lastquest3)) {
                        ...
                        quest3 = alea3 == 1 ? "tr" : (alea3 == 2 ? "hr" : (alea3 == 3 ? "mana" : (alea3 == 4 ? "atk" : (alea3 == 5 ? "def" : (alea3 == 6 ? "exp" : (alea3 == 7 ? "invest" : (alea3 == 8 ? "vote" : (alea3 == 9 ? "shop" : (alea3 == 10 ? "soldier" : (alea3 == 11 ? "jetons" : (alea3 == 12 ? "materiau" : (alea3 == 13 ? "bois" : (alea3 == 14 ? "acier" : (alea3 == 15 ? "brique" : (alea3 == 16 ? "verre" : (alea3 == 17 ? "pierre" : (alea3 == 18 ? "petrole" : "tr")))))))))))))))));
                    }
                    TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Quests/quest3.txt", quest3, 1);
                }
            }
        };
        ScheduledFuture<?> Guild_BonusHandle = scheduler1.scheduleAtFixedRate(Guild_Bonus_Update, 5L, 5L, TimeUnit.MINUTES);
    }
            ...
            public void run() {
                ...
                if (day != LastPaysDate && hour == 0) {
                    ...
                    for (File file : files = repertoire.listFiles()) {
                        ...
                        TextFileWriter.folder("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/bois.txt");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/argile.txt");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/cuir.txt");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/pierre.txt");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/paille.txt");
                        TextFileWriter.delete("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/fer.txt");
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/" + materiau3 + ".txt", "1", 1);
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/" + materiau2 + ".txt", "2", 1);
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/" + materiau21 + ".txt", "3", 1);
                        ...
                        TextFileWriter.write("/home/DiscordBot/Rasberry/données/bot/Pays/" + file.getName() + "/materiaux/" + materiau1 + ".txt", "5", 1);
                    }
                }
            }
        };
    ...
    public static void Message_Delete(int minutes, TimeUnit timeUnit, final Message message) {
        ...
        final ScheduledFuture<?> Message_DeleteHandle = scheduler1.scheduleAtFixedRate(Message_Delete_Update, minutes, minutes, timeUnit);
        scheduler1.schedule(new Runnable(){
    ...
    public static void Mute(final User user, int minutes, MessageChannel channel, final Guild guild) {
        ...
        final ScheduledFuture<?> MuteHandle = scheduler1.scheduleAtFixedRate(Mute_Update, minutes, minutes, TimeUnit.MINUTES);
        scheduler1.schedule(new Runnable(){
                ...
                try {
                    ...
                    for (int i = 0; i < guild.getMembers().size(); ++i) {
                        ...
                        block65 : for (int j = 1; j <= level + 50; ++j) {
                            ...
                            guild.getController().addRolesToMember(guild.getMembers().get(i), guild.getRolesByName("\u1801\u1801\u1801 Social levels \u1801\u1801\u1801", true)).queue();
                            int boucle = 2;
                            String rank = null;
                            try {
                                rank = TextFileWriter.read1("/home/DiscordBot/Rasberry/données/Users/" + user.getId() + "/rank.txt", boucle);
                                while (rank != null) {
                                    if (rank.equals("0") || rank == null || rank.equals("")) continue block65;
                                    guild.getController().addRolesToMember(guild.getMembers().get(i), guild.getRolesByName("\u1801\u1801\u1801 Events ranks \u1801\u1801\u1801", true)).queue();
                        ...
                        guild.getController().addRolesToMember(guild.getMembers().get(i), guild.getRolesByName("\u1801\u1801\u1801 Game levels \u1801\u1801\u1801", true)).queue();
                        guild.getController().addRolesToMember(guild.getMembers().get(i), add_role1).queue();
                        if (guild.getMembers().get(i).getUser().getId().equals("102108573298851840") || guild.getMembers().get(i).getUser().getId().equals("284730935331782657") || guild.getMembers().get(i).getUser().getId().equals("502535486691082279") || guild.getMembers().get(i).getUser().getId().equals("249987060365000704")) {
                            guild.getController().addRolesToMember(guild.getMembers().get(i), guild.getRolesByName("\u1801\u1801\u1801 Server ranks \u1801\u1801\u1801", true)).queue();
                        } else {
                            guild.getController().removeRolesFromMember(guild.getMembers().get(i), guild.getRolesByName("\u1801\u1801\u1801 Server ranks \u1801\u1801\u1801", true)).queue();
                        }
                        String emoji = "";
                        ...
                        Message mess = jda.getGuildById("326345972739473410").getTextChannelById("392366630912655372").getMessageById("542026527953649664").complete();
                        List list = null;
                        List list2 = null;
                        List list3 = null;
                        List list4 = null;
                        for (MessageReaction mess1 : mess.getReactions()) {
                            ...
                            if (mess1.getReactionEmote().getName().equals(jda.getGuildById("326345972739473410").getEmotesByName("levelupbadge", true).get(0).getName())) {
                            ...
                            if (!mess1.getReactionEmote().getName().equals("\ud83d\udcf2")) continue;
                            list3 = (List)mess1.getUsers().complete();
                        }
                        boolean emoji1 = true;
                        for (User user1 : mess.getReactions().get(0).getUsers()) {
                            if (!user1.getId().equals(user.getId())) continue;
                            emoji1 = false;
                        }
                        boolean level1 = true;
                        ...
                        if (emoji1 && level1) {
                            if (Ulevel != 0) {
                                if (guild.getSelfMember().hasPermission(Permission.NICKNAME_MANAGE) && user.getName().length() <= 27) {
                                    if (!guild.getMembers().get(i).hasPermission(Permission.ADMINISTRATOR)) {
                                        guild.getController().setNickname(guild.getMembers().get(i), "[" + Ulevel + emoji + "] " + pseudo).queue();
                                    }
                                }
                            }
                            ...
                            if (Ulevel != 0) {
                                if (guild.getSelfMember().hasPermission(Permission.NICKNAME_MANAGE) && user.getName().length() <= 27) {
                                    if (!guild.getMembers().get(i).hasPermission(Permission.ADMINISTRATOR)) {
                                        guild.getController().setNickname(guild.getMembers().get(i), "[" + Ulevel + "] " + pseudo).queue();
                                    }
                                }
                            }
                        } else if (emoji1 && !level1) {
                            if (Ulevel != 0) {
                                if (guild.getSelfMember().hasPermission(Permission.NICKNAME_MANAGE) && user.getName().length() <= 27) {
                                    if (!guild.getMembers().get(i).hasPermission(Permission.ADMINISTRATOR)) {
                                        guild.getController().setNickname(guild.getMembers().get(i), "[" + emoji + "] " + pseudo).queue();
                                    }
                                }
                            }
                        } else if (Ulevel != 0) {
                        ...
                        for (User user1 : mess.getReactions().get(2).getUsers()) {
                            ...
                            if (user1.getId().equals(user.getId())) {
                                guild.getController().addRolesToMember(member, guild.getRolesByName("\u1801\u1801\u1801 Notifications settings \u1801\u1801\u1801", true)).queue();
                                guild.getController().addRolesToMember(member, guild.getRolesByName("\ud83d\udd14 notifications", true));
                                continue;
                            }
                            guild.getController().removeRolesFromMember(member, guild.getRolesByName("\ud83d\udd14 notifications", true));
                        }
                        for (User user1 : mess.getReactions().get(3).getUsers()) {
                            ...
                            if (member == null) continue;
                            if (user1.getId().equals(user.getId())) {
                                guild.getController().addRolesToMember(guild.getMember(user1), guild.getRolesByName("\u1801\u1801\u1801 Notifications settings \u1801\u1801\u1801", true)).queue();
                                guild.getController().addRolesToMember(guild.getMember(user1), guild.getRolesByName("\ud83d\udd14 notif-events", true));
                                continue;
                            }
                            guild.getController().removeRolesFromMember(guild.getMember(user1), guild.getRolesByName("\ud83d\udd14 notif-events", true));
                        }
                    }
                }
                catch (Exception e) {
