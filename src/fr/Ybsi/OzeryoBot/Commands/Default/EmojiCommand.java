...
public class EmojiCommand {
    ...
    private void emoji(User user, MessageChannel channel, Guild guild, String[] args, Message message, command.Language lang) {
        ...
        int NbEmoji = TextFileWriter.folderlength("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/common/") + TextFileWriter.folderlength("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/uncommon/");
        ...
        if (c1.equals("")) {
            ...
            int page = c2;
            for (int i = 1; i <= 15; ++i) {
                if (TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/" + i + ".txt").equals("true")) {
            ...
            if (build.equals("owned")) {
                ...
                builder.setDescription("Vous avez " + NbEmoji + " Emoji Sur 118");
                for (i = 1; i <= 118; ++i) {
                    if (!TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/common/" + i + ".txt").equals("true")) continue;
                    builder.addField("**Emoji " + i + "** ( common )", "\u2705 Owned \u2705", true);
                }
                for (i = 1; i <= 69; ++i) {
                    if (!TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/uncommon/" + i + ".txt").equals("true")) continue;
                ...
                while (i <= imax) {
                    if (TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/" + rarity + "/" + i + ".txt").equals("true")) {
                ...
                builder.setFooter("Page " + page + " sur 14 | tape =emoji list " + NextPage + " pour acceder a la page suivante", null);
                channel.sendMessage(builder.build()).queue();
            }
        } else if (c1.equals("claim")) {
            int jetons = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/jeton.txt"));
            if (jetons == 0) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Desol\u00e9 mais vous n'avez pas assez de jeton pour debloquer un emoji !!").queue();
                }
                ...
                if (alea1 <= 0.39) {
                    ...
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/common/" + alea2 + ".txt", "true", 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/jeton.txt", Integer.toString(jetons), 1);
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous avez debloquerun nouvel Emoji (commun). Faites =emoji common " + alea2 + " pour l'afficher").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage("You unlock a new emoji (commun). Do =emoji common " + alea2 + " to see it").queue();
                    }
                } else if (alea1 > 0.39 && alea1 <= 0.69) {
                    int alea2 = 1 + (int)(Math.random() * 69.0);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/uncommon/" + alea2 + ".txt", "true", 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/jeton.txt", Integer.toString(jetons), 1);
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous avez debloquerun nouvel Emoji (peu commun). Faites =emoji uncommon " + alea2 + " pour l'afficher").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage("You unlock a new emoji (uncommun). Do =emoji uncommon " + alea2 + " to see it.").queue();
                    }
                } else if (alea1 > 0.69 && alea1 <= 0.87) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Au non ce n'est pas de chance il n'y a pas encore d'objet rare a gagner.").queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Au non ce n'est pas de chance il n'y a pas encore d'objet epique a gagner.").queue();
                    }
                    if (lang == command.Language.en) {
                    ...
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Au non ce n'est pas de chance il n'y a pas encore d'objet legendaire a gagner.").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage("Oh no this is bad luck, there is not legendary object to win yet.").queue();
                    }
                } else if (alea1 > 0.99) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Au non ce n'est pas de chance il n'y a pas encore d'objet mythic a gagner.").queue();
                    }
                    if (lang == command.Language.en) {
            ...
            if (rarity.equals("common") || rarity.equals("uncommon")) {
                String verif = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/emojis/" + rarity + "/" + emojis + ".txt");
