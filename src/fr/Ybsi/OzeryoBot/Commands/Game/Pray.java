        ...
        if (lang != command.Language.en) return;
           channel.sendMessage("You must build your Church to perform this command.").queue();
            return;
                                            ...
                                            int Lday = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/Users/" + user.getId() + "/eglise/day.txt"));
                                            int Lmonth = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/données/Users/" + user.getId() + "/eglise/month.txt"));
