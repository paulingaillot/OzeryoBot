...
public class Heroe {
    ...
    private void hero(Message message, User user, String[] args, MessageChannel channel, Guild guild, ProfilData data, command.Language lang) {
        ...
        if (c1.equals("info") || c1.equals("")) {
            ...
            int PV = Heroe.getPV(activeHero, user);
            int pvtotal = Heroe.getmaxPV(activeHero, level2);
            int ATK = Heroe.getAtk(activeHero, level2, user);
            int DEF = Heroe.getDef(activeHero, level2, user);
        ...
        if (c1.equals("equip")) {
            ...
            if (c3 == 0) {
                ...
                try {
                    ...
                    if (lang == command.Language.en) {
                        channel.sendMessage("You don't have any hero selected. Please select a hero with the command ``=hero select``").queue();
                    }
                    return;
                }
                if (weapon3 == true) {
        ...
        if (c1.equals("weaponupgrade") || c1.equals("wupgrade") || c1.equals("wup")) {
            ...
            if (level9 != 1) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous devez totu d'abord construire le garage pour pouvoir amliorer vos armes").queue();
                }
                if (lang == command.Language.en) {
            ...
            int c3 = 0;
            for (String str : args) {
                if (str.equals(args[0]) || str.equals(Integer.toString(c4))) continue;
                try {
                    c3 = Integer.parseInt(str);
                }
            ...
            if (weapon4) {
                ...
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous venez de creer une arme de niveau " + (level1 + 1) + " en fusionnant deux armes de niveau " + level1 + ".").queue();
                }
                if (lang == command.Language.en) {
                    channel.sendMessage("You just createa weapon level " + (level1 + 1) + " by merging two weapons level " + level1 + ".").queue();
                }
            } else if (armor13) {
                int level2;
                ...
                data.getProfils().get(user.getId()).setMelting(data.getProfils().get(user.getId()).getMelting() + 1);
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous venez de creer une armure de niveau " + (level1 + 1) + " en fusionnant deux armures de niveau " + level1 + ".").queue();
                }
                if (lang == command.Language.en) {
                    channel.sendMessage("You just create an armor level " + (level1 + 1) + " by merging two armors level " + level1 + ".").queue();
                }
            }
        }
        if (c1.equals("armor")) {
        ...
        if (c1.equals("select")) {
            ...
            try {
                if (((String)list24.get(2)).equals("true")) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Veuillez attendre que votre hero actif soit au repos avant dans selectionner un autre.").queue();
                    }
                    if (lang == command.Language.en) {
                        channel.sendMessage("You must wait your active hero be at rest to select another hero.").queue();
                    }
                    return;
                }
            }
        ...
        if (c1.equals("list")) {
            ...
            if (money < cout) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous n'avez pas asser d'argent pour ameliorer votre hero. L'amelioration de votre hero au niveau " + (level10 + 1) + " coute " + cout + "$").queue();
                }
                if (lang == command.Language.en) {
                    channel.sendMessage("You don't have enough money to upgrade your hero. This hero upgrade to level " + (level10 + 1) + " cost " + cout + "$").queue();
                }
                return;
            }
    ...
    public static String getRarity(String hero) {
        ...
        if (hero.equals("Karl")) {
            ...
            rarity = "Rare";
        } else if (hero.equals("Yegarde") || hero.equals("Angel") || hero.equals("Zhen") || hero.equals("Hearth") || hero.equals("Lixie") || hero.equals("Akashi")) {
            rarity = "Epic";
    ...
    public static int getAtk(String hero, int level, User user) {
        HashMap<String, ArrayList<String>> heroe;
        ...
        atk += levelarmor * 50;
        if (hero.equals("Valkyrie") || hero.equals("Yegarde") || hero.equals("Akashi") || hero.equals("Zhen") || hero.equals("Rose") || hero.equals("Hell") || hero.equals("Spirita") || hero.equals("Ivoire")) {
            atk *= 2;
        }
        return atk;
    }

    public static int getDef(String hero, int level, User user) {
        HashMap<String, ArrayList<String>> heroe;
        ArrayList<String> list;
        ...
        def += levelarmor * 50;
        if (hero.equals("Ouranos") || hero.equals("Zhen") || hero.equals("Hearth") || hero.equals("Lixie") || hero.equals("Hell") || hero.equals("Rose") || hero.equals("Tempest") || hero.equals("Ivoire")) {
            def *= 2;
        }
        return def;
    }

    public static int getPV(String hero, User user) {
        HashMap<String, ArrayList<String>> heroe;
        ArrayList<String> list;
        ProfilData data = DiscordBot.getData();
        try {
    ...
    public static int getmaxPV(String heroe, int level) {
        ...
        if (heroe.equals("Oeil") || heroe.equals("Angel") || heroe.equals("Hearth") || heroe.equals("Yegarde") || heroe.equals("Hell") || heroe.equals("Spirita") || heroe.equals("Tempest") || heroe.equals("Ivoire")) {
    ...
    public static int getMagic(String heroe, int level) {
        ...
        if (heroe.equals("Ikaryus") || heroe.equals("Angel") || heroe.equals("Lixie") || heroe.equals("Akashi") || heroe.equals("Rose") || heroe.equals("Spirita") || heroe.equals("Tempest") || heroe.equals("Ivoire")) {
            magic *= 2;
        }
        return magic;
    }
