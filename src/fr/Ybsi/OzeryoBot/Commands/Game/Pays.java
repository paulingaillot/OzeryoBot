...
public class Pays {
    ...
    private void pays(MessageChannel channel, User user, String[] args, Message message, Guild guild, JDA jda, ProfilData data, command.Language lang) {
        int level;
        ...
        if (pays.equals("") && !c1.equals("create") && !c1.equals("join")) {
            if (lang == command.Language.fr) {
                channel.sendMessage("\u26a0 Vous devez etre dans un pays pour pouvoir executer cette commande.").queue();
            }
        ...
        try {
            for (File file1 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles")) {
                if (!TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName() + "/" + user.getId()).equals("true")) continue;
                rank1 = file1.getName();
                for (File file2 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName() + "/perm")) {
        ...
        if (c1.equals("")) {
            ...
            String BBois = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/bois.txt");
            String Bargile = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/argile.txt");
            String Bcuir = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/cuir.txt");
            String Bpierre = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/pierre.txt");
            String Bpaille = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/paille.txt");
            String Bfer = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/fer.txt");
            TextFileWriter.folder("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/");
            int Rbois = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/bois.txt"));
            int Rargile = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/argile.txt"));
            int Rcuir = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/cuir.txt"));
            int Rpierre = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/pierre.txt"));
            int Rpaille = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/paille.txt"));
            int Rfer = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/fer.txt"));
            int troph\u00e9es = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/trophy.txt"));
            double level2 = point / 1000;
            double level32 = Math.sqrt(level2);
            int level4 = (int)Math.round(level32);
            String description = "aucun";
            try {
                description = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/description.txt");
            }
            ...
            try {
                for (File file : files) {
                    ...
                    int secondes = 0;
                    try {
                        secondes = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user1 + "/LastMessage/secondes.txt"));
                    }
                    ...
                    int minutes = 0;
                    try {
                        minutes = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user1 + "/LastMessage/minutes.txt"));
                    }
                    catch (NullPointerException nullPointerException) {
                        // empty catch block
                    }
                    int heures = 0;
                    try {
                        heures = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user1 + "/LastMessage/heures.txt"));
                    }
                    catch (NullPointerException nullPointerException) {
                        // empty catch block
                    }
                    int jours = 0;
                    try {
                        jours = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user1 + "/LastMessage/jours.txt"));
                    }
                    catch (NullPointerException nullPointerException) {
                        // empty catch block
                    }
            ...
            int popPays = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt"));
            int bank = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/bank.txt"));
            String discordurl = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/discordURL.txt");
            ...
            if (lang == command.Language.fr) {
                builder2.setDescription(":reminder_ribbon: **Level :** " + level4 + "\n\n " + ":rosette: **Points :** " + points + "\n\n" + ":clipboard: **Description :** ``" + description + "``\n\n" + ":inbox_tray: **Discord :** " + discordurl + "\n\n" + ":busts_in_silhouette: **Troupes :** " + popPays + "\n\n" + ":trophy: **Troph\u00e9es :** " + troph\u00e9es + "\n");
            }
            if (lang == command.Language.en) {
                builder2.setDescription(":reminder_ribbon: **Level :** " + level4 + "\n\n " + ":rosette: **Points :** " + points + "\n\n" + ":clipboard: **Description :** ``" + description + "``\n\n" + ":inbox_tray: **Discord :** " + discordurl + "\n\n" + ":busts_in_silhouette: **Troops :** " + popPays + "\n\n" + ":trophy: **Trophies :** " + troph\u00e9es + "\n");
            }
            if (lang == command.Language.fr) {
                builder2.addField(":scales: Ressources :", "\n" + jda.getGuildById("326345972739473410").getEmotesByName("wood", true).get(0).getAsMention() + " - **Bois (" + BBois + "Pts)** : " + Rbois + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("clay", true).get(0).getAsMention() + " - **Argile (" + Bargile + "Pts)** : " + Rargile + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("leather", true).get(0).getAsMention() + " - **Cuir (" + Bcuir + "Pts)** : " + Rcuir + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("stone", true).get(0).getAsMention() + " - **Pierre (" + Bpierre + "Pts)** : " + Rpierre + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("straw", true).get(0).getAsMention() + " - **Paille (" + Bpaille + "Pts)** : " + Rpaille + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("iron", true).get(0).getAsMention() + " - **Fer (" + Bfer + "Pts)** : " + Rfer + "\n \n" + ":money_with_wings: **Bank :** " + bank + "$\n\n" + ":bust_in_silhouette: Members : " + TextFileWriter.folderlength("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/"), true);
            }
            if (lang == command.Language.en) {
                builder2.addField(":scales: Ressources :", "\n" + jda.getGuildById("326345972739473410").getEmotesByName("wood", true).get(0).getAsMention() + " - **Wood (" + BBois + "Pts)** : " + Rbois + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("clay", true).get(0).getAsMention() + " - **Clay (" + Bargile + "Pts)** : " + Rargile + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("leather", true).get(0).getAsMention() + " - **Leather (" + Bcuir + "Pts)** : " + Rcuir + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("stone", true).get(0).getAsMention() + " - **Stone (" + Bpierre + "Pts)** : " + Rpierre + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("straw", true).get(0).getAsMention() + " - **Straw (" + Bpaille + "Pts)** : " + Rpaille + "\n" + jda.getGuildById("326345972739473410").getEmotesByName("iron", true).get(0).getAsMention() + " - **Iron (" + Bfer + "Pts)** : " + Rfer + "\n \n" + ":money_with_wings: **Bank :** " + bank + "$\n\n" + ":bust_in_silhouette: Members : " + TextFileWriter.folderlength("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/"), true);
            }
        ...
        if (c1.equals("level")) {
            ...
            bonus = level > 74 ? String.valueOf(bonus) + "+100% de vitesse de recuperation des ressources dans les zones de ressources : :white_check_mark: \n" : String.valueOf(bonus) + "+100% de vitesse de recuperation des ressources dans les zones de ressources : d\u00e9bloqu\u00e9 au niveau 74 \n";
            ...
            bonus = level > 84 ? String.valueOf(bonus) + "+50% de vitesse de deplacement sur la map : :white_check_mark: \n" : String.valueOf(bonus) + "+50% de vitesse de deplacement sur la map : d\u00e9bloqu\u00e9 au niveau 84 \n";
            ...
            bonus = level > 94 ? String.valueOf(bonus) + "-50% de delay pour reconstruire le laboratoire : :white_check_mark: \n" : String.valueOf(bonus) + "-50% de delay pour reconstruire le laboratoire : d\u00e9bloqu\u00e9 au niveau 94 \n";
            bonus = level > 98 ? String.valueOf(bonus) + "+50% de vitesse de regen du hero : :white_check_mark:" : String.valueOf(bonus) + "+50% de vitesse de regen du hero : d\u00e9bloqu\u00e9 au niveau 98";
            ...
            builder3.addField("Machine", "Nombre de marchine : " + machine + "\n Prochaine machine d\u00e9bloqu\u00e9 au niveau " + levelmachine, true);
            builder3.addField("Bonus", bonus, true);
            builder3.addBlankField(false);
            builder3.addField("Mermbres", "Membres maximums : " + membres + "\n Prochain gain de membres level " + membresnext, true);
        ...
        if (c1.equals("machine")) {
            if (c2.equals("") || c2.equals("machine")) {
                ...
                for (int o = 1; o <= machine; ++o) {
                    String bonus = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/bonus" + o + ".txt");
                    String etat = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/machine" + o + ".txt");
                    int cout = 0;
                    try {
                        cout = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/cout" + o + ".txt"));
                    }
            ...
            if (c2.equals("start")) {
                ...
                int i = 1;
                for (o = 1; o <= machine; ++o) {
                    if (!c3.equals("machine" + o)) continue;
                    i = o;
                    test = true;
                }
                ...
                int bonus = 0;
                try {
                    bonus = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/bonus" + i + ".txt"));
                }
                catch (Exception cout) {
                    // empty catch block
                }
                if (bonus == 0) {
                    channel.sendMessage("Vous devez d'abord set un bonus pour activer votre machine country machine set [numero du bonus]").queue();
                    return;
                }
                String state = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/" + c3 + ".txt");
                if (state.equals("active")) {
                    channel.sendMessage("Votre machine est deja en cours d'utilisation.").queue();
                    return;
                }
                long money = Long.parseLong(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/bank.txt"));
                long cout = 0L;
                try {
                    cout = Long.parseLong(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/cout" + i + ".txt"));
                }
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/bank.txt", Long.toString(money -= cout), 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/lastpay" + i + ".txt", Long.toString(System.currentTimeMillis()), 1);
                cout = (long)((double)cout * 1.05);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/cout" + i + ".txt", Long.toString(cout), 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/" + c3 + ".txt", "active", 1);
            ...
            if (c2.equals("set")) {
                ...
                if (!test.booleanValue()) {
                    channel.sendMessage("Vous ne pouvez pas modifier le bonus d'une machine que vous ne possedez pas").queue();
                    return;
                }
                int bonus = 0;
                try {
            ...
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/" + c3 + ".txt", "stop", 1);
        ...
        if (c1.equals("emoji") && ((Boolean)map.get("emoji")).booleanValue()) {
            ...
            level = (int)Math.round(level3);
            String emoji = c2;
            if (emoji.equals("\ud83d\udcaf") && level < 10 || emoji.equals("\ud83c\udf88") && level < 15 || emoji.equals("\ud83c\udf40") && level < 25 || emoji.equals("\ud83d\udc8e") && level < 35 || emoji.equals("\u2620") && level < 70 || emoji.equals("\u26a1") && level < 100 || emoji.equals("\ud83d\udc51") && level < 225) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Le niveau de votre pays semble trop faible pour utiliser cet emoji : \n- level 10 : :100: \r\n- level 15 : :balloon: \r\n- level 25 : :four_leaf_clover: \r\n- level 35 : :gem: \r\n- level 70 : :skull_crossbones: \r\n- level 100 : :zap: \r\n- level 225 : :crown: ").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("Your country level is too low to use this emoji : \n- level 10 : :100: \r\n- level 15 : :balloon: \r\n- level 25 : :four_leaf_clover: \r\n- level 35 : :gem: \r\n- level 70 : :skull_crossbones: \r\n- level 100 : :zap: \r\n- level 225 : :crown: ").queue();
                return;
            }
            if (emoji.equals("\ud83d\udcaf") && level >= 10 || emoji.equals("\u2618\ufe0f") && level >= 15 || emoji.equals("\ud83c\udf40") && level >= 25 || emoji.equals("\ud83d\udc8e") && level >= 35 || emoji.equals("\u2620") && level >= 70 || emoji.equals("\u26a1") && level >= 100 || emoji.equals("\ud83d\udc51") && level < 225) {
                ...
                if (lang == command.Language.fr) {
                    channel.sendMessage("Cet emoji ne peut pas etre utilis\u00e9 comme recompense de level du pays. \n- level 10 : :100: \r\n- level 15 : :balloon: \r\n- level 25 : :four_leaf_clover: \r\n- level 35 : :gem: \r\n- level 70 : :skull_crossbones: \r\n- level 100 : :zap: \r\n- level 225 : :crown: ").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("This emojis can be used as country's rewards. \n- level 10 : :100: \r\n- level 15 : :balloon: \r\n- level 25 : :four_leaf_clover: \r\n- level 35 : :gem: \r\n- level 70 : :skull_crossbones: \r\n- level 100 : :zap: \r\n- level 225 : :crown: ").queue();
            }
            return;
        }
        if (c1.equals("role") && ((Boolean)map.get("giver")).booleanValue()) {
            ...
            Boolean test = false;
            File[] Bpaille = TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/");
            int level3 = Bpaille.length;
            for (int Bcuir = 0; Bcuir < level3; ++Bcuir) {
                File file = Bpaille[Bcuir];
                if (!file.getName().equals(rank)) continue;
                test = true;
            }
            if (!test.booleanValue()) {
                if (lang == command.Language.fr) {
            ...
            for (File file1 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles")) {
                if (!TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName() + "/" + cible2.getId()).equals("true")) continue;
                TextFileWriter.delete("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName() + "/" + cible2.getId());
            }
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + rank + "/" + cible2.getId(), "true", 1);
            if (lang == command.Language.fr) {
        ...
        if (c1.equals("perm")) {
            ...
            if (c2.equals("add") && ((Boolean)map.get("modifr")).booleanValue()) {
                ...
                Boolean test = false;
                for (File file : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/")) {
                    if (!file.getName().equals(rank)) continue;
                    test = true;
                }
                if (!test.booleanValue()) {
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + rank + "/perm/" + perm, "true", 1);
                if (lang == command.Language.fr) {
                ...
                if (!c2.equals("remove") || !((Boolean)map.get("modifr")).booleanValue()) return;
                rank = c3.replaceAll(" ", "_");
                Boolean test = false;
                for (File file : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/")) {
                    if (!file.getName().equals(rank)) continue;
                ...
                TextFileWriter.delete("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + rank + "/perm/" + perm);
                if (lang == command.Language.fr) {
                    channel.sendMessage("Le role " + rank + " n'a desormais plus la permission : ``" + perm + "``").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("The rank " + rank + " now haven't longer the permission : ``" + perm + "``").queue();
            }
            return;
        }
        if (c1.equals("rank") && ((Boolean)map.get("creater")).booleanValue()) {
            ...
            if (c2.equals("add")) {
                ...
                TextFileWriter.folder("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + rank + "/perm");
                if (lang == command.Language.fr) {
                    channel.sendMessage("Le role " + c3 + " a \u00e9t\u00e9 cr\u00e9\u00e9. Vous pouvez desormais selectionner ces permissions et le donner aux membres de votre pays.").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("The rank " + c3 + " has created. Vous pouvez desormais selectionner ces permissions et le donner aux membres de votre pays.").queue();
                return;
            }
            if (c2.equals("remove")) {
                rank = c3.replaceAll(" ", "_");
                try {
                    TextFileWriter.recursifDelete(new File("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + rank));
                }
                catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        if (c1.equals("bank")) {
            ...
            if (c2.equals("add")) {
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/bank.txt", Integer.toString(bank), 1);
                if (lang == command.Language.fr) {
            ...
            if (!c2.equals("credit") || !((Boolean)map.get("creditb")).booleanValue()) return;
        ...
        if (c1.equals("discord") && ((Boolean)map.get("changed")).booleanValue()) {
            ...
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/discordURL.txt", builder.toString(), 1);
            if (lang == command.Language.fr) {
        ...
        if (c1.equals("setdescription") || c1.equals("description") && ((Boolean)map.get("desc")).booleanValue()) {
            ...
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/description.txt", builder.toString(), 1);
            if (lang == command.Language.fr) {
        ...
        if (c1.equals("give")) {
            ...
            int popPays = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt"));
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt", Integer.toString(popPays += givePop), 1);
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/Users/" + user.getId() + "/soldier.txt", Long.toString(soldier), 1);
            if (lang == command.Language.fr) {
        ...
        if (c1.equals("members") && ((Boolean)map.get("showm")).booleanValue()) {
            ...
            messages = String.valueOf(messages) + "---- **Owner** ---- \n" + jda.getUserById(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/owner.txt")).getName() + " (" + TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/owner.txt") + ") \n\n";
            for (File file1 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles")) {
                messages = String.valueOf(messages) + " ---- **" + file1.getName() + "** ----\n";
                for (File file2 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName())) {
                    if (file2.getName().equals("perm")) continue;
                    messages = String.valueOf(messages) + jda.getUserById(file2.getName()).getName() + " (" + file2.getName() + ") \n";
                }
                messages = String.valueOf(messages) + "\n";
            }
            messages = String.valueOf(messages) + " ---- **Members** ----\n";
            for (File members : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member")) {
                if (messages.contains(jda.getUserById(members.getName()).getName())) continue;
                messages = String.valueOf(messages) + jda.getUserById(members.getName()).getName() + " (" + members.getName() + "\n";
            }
        ...
        if (c1.equals("rename") && ((Boolean)map.get("prename")).booleanValue()) {
            ...
            if (test.equals("true")) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("\u26a0 Il existe deja une guilde de ce nom, veuillez en choisir un autre.").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("\u26a0There is already a country with this name, please type another name.").queue();
                return;
            }
            for (File member : members = TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/")) {
        ...
        if (c1.equals("kick") && ((Boolean)map.get("kick")).booleanValue()) {
            ...
            try {
                test = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/" + cible.getId());
            }
            catch (NullPointerException e) {
                test = "";
            }
            ...
            for (File file1 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles")) {
                for (File file2 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName())) {
                    if (file2.getName().equals("perm") || !file2.getName().equals(cible.getId())) continue;
        ...
        if (c1.equals("lead")) {
            ...
            if (owner.equals(user.getId())) {
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/owner.txt", cible.getId(), 1);
                if (lang == command.Language.fr) {
        ...
        if (c1.equals("leave")) {
            if (owner.equals(user.getId())) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous ne pouvez pas quitter votre pays car vous en etes l'owner. (tape =country disband)").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("You can't leave the country because your are the owner (type =country disband).").queue();
                return;
            }
            try {
            ...
            for (File file1 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles")) {
                for (File file2 : TextFileWriter.folderlist("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/roles/" + file1.getName())) {
                    if (file2.getName().equals("perm") || !file2.getName().equals(user.getId())) continue;
                    TextFileWriter.delete(file2.getAbsolutePath());
                }
            }
        ...
        if (c1.equals("invite") && ((Boolean)map.get("invite")).booleanValue()) {
            ...
            if (membres >= 10) {
                if (lang == command.Language.fr) {
                    channel.sendMessage("Vous avez atteind la limite de membres du pays, vous ne pouvez pas inviter plus de personne").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("You reached the country member's limit, you can't inviter player anymore.").queue();
                return;
            }
            User user_invite = message.getMentionedUsers().get(0);
            TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/" + user_invite.getId(), "invite", 1);
            if (lang == command.Language.fr) {
                channel.sendMessage("Le joueur " + user_invite.getName() + " a bien \u00e9t\u00e9 inviter dans votre pays. Celui ci a 5 minutes pour accepter votre invitation.").queue();
            }
            if (lang == command.Language.en) {
                channel.sendMessage("The player " + user_invite.getName() + " has successfully invited in your country. He have 5 minutes to accept your invitation.").queue();
            }
            Scheduler.File_Delete(5, TimeUnit.MINUTES, "/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/member/" + user_invite.getId());
            return;
        }
        if (c1.equals("attack") && ((Boolean)map.get("pattack")).booleanValue()) {
            String pays_adv = c2;
            if (TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/pays.txt").equals("true")) {
                int troph\u00e9esV;
                int gain;
                int troupe = 0;
                try {
                ...
                if (troupe > Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt"))) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("Vous ne pouvez pas attaquer avec plus de troupes que vous n'en avait").queue();
                    }
                    if (lang != command.Language.en) return;
                    channel.sendMessage("You can't attack with more soldier than you have").queue();
                    return;
                }
                int total_troupe = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt"));
                int troupe_adv = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/habitants.txt"));
                if (troupe > troupe_adv) {
                    troupe = total_troupe - troupe;
                    troupe_adv = 0;
                    int troph\u00e9esP = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/trophy.txt"));
                    troph\u00e9esV = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/trophy.txt"));
                    int dif = troph\u00e9esV - troph\u00e9esP;
                    gain = dif > 500 ? 1 : (dif > 300 && dif <= 500 ? 5 : (dif > 100 && dif <= 300 ? 10 : (dif > 0 && dif <= 100 ? 20 : (dif <= 0 ? 30 : 1))));
                    troph\u00e9esP = troph\u00e9esP > gain ? (troph\u00e9esP -= gain) : 0;
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt", Integer.toString(troupe), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/trophy.txt", Integer.toString(troph\u00e9esV += gain), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/habtiants.txt", Integer.toString(troupe_adv), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/trophy.txt", Integer.toString(troph\u00e9esP), 1);
                    User owner_adv = jda.getUserById(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/owner.txt"));
                    if (lang == command.Language.fr) {
                    ...
                    if (lang == command.Language.fr) {
                        ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Rapport d'Attaque de Pays :crossed_swords: \n Vous avez gagn\u00e9. Vous remportez " + gain + " Troph\u00e9es et perdez " + troupe + " soldats").queue();
                    }
                    if (lang == command.Language.en) {
                        ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Country Attack report :crossed_swords: \n You won. You win " + gain + " trophies and loses " + troupe + " soldiers").queue();
                    }
                    ...
                    if (langc == command.Language.fr) {
                        ((UserImpl)owner_adv).getPrivateChannel().sendMessage(":crossed_swords: Rapport de defense de Pays :crossed_swords: \n Vous avez Perdu. Vous perdez " + gain + " Troph\u00e9es et perdez " + troupe_adv + " soldats").queue();
                    }
                    if (langc != command.Language.en) return;
                    ((UserImpl)owner_adv).getPrivateChannel().sendMessage(":crossed_swords: Country Defense report :crossed_swords: \n You lose. You lose " + gain + " trophies and lose " + troupe_adv + " soldiers").queue();
                    return;
                } else {
                    if (troupe_adv <= troupe) return;
                    troupe = total_troupe - troupe;
                    int troph\u00e9esP = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/trophy.txt"));
                    troph\u00e9esV = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/trophy.txt"));
                    int dif = troph\u00e9esV - troph\u00e9esP;
                    gain = dif > 500 ? 1 : (dif > 300 && dif <= 500 ? 5 : (dif > 100 && dif <= 300 ? 10 : (dif > 0 && dif <= 100 ? 20 : (dif <= 0 ? 30 : 1))));
                    troph\u00e9esP = troph\u00e9esP > gain ? (troph\u00e9esP -= gain) : 0;
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/habitants.txt", Integer.toString(troupe), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/trophy.txt", Integer.toString(troph\u00e9esP), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/habtiants.txt", Integer.toString(troupe_adv -= troupe), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/trophy.txt", Integer.toString(troph\u00e9esV += gain), 1);
                    User owner_adv = jda.getUserById(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays_adv + "/owner.txt"));
                    if (!user.hasPrivateChannel()) {
                        user.openPrivateChannel().complete();
                    }
                    if (lang == command.Language.fr) {
                        ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Rapport d'Attaque de Pays :crossed_swords: \n Vous avez Perdu. Vous perdez " + gain + " Troph\u00e9es et perdez " + troupe + " soldats").queue();
                    }
                    if (lang == command.Language.en) {
                        ((UserImpl)user).getPrivateChannel().sendMessage(":crossed_swords: Country attack report :crossed_swords: \n You lose. You lose " + gain + " trophies and " + troupe + " soldiers").queue();
                    }
                    if (!owner_adv.hasPrivateChannel()) {
                        owner_adv.openPrivateChannel().complete();
                    }
                    if (lang == command.Language.fr) {
                        ((UserImpl)owner_adv).getPrivateChannel().sendMessage(":crossed_swords: Rapport de defense de Pays :crossed_swords: \n Vous avez Gagn\u00e9. Vous remportez " + gain + " Troph\u00e9es et perdez " + troupe_adv + " soldats").queue();
                    }
                    if (lang != command.Language.en) return;
                    ((UserImpl)owner_adv).getPrivateChannel().sendMessage(":crossed_swords: Country defense report :crossed_swords: \n You won. You won " + gain + " trophies and lose " + troupe_adv + " soldiers").queue();
                }
                return;
            }
            if (lang == command.Language.fr) {
        ...
        if (c1.equals("create")) {
            ...
            if (money >= 10000000L && !Premium.Premium(user) || money >= 1000000L && Premium.Premium(user)) {
                ...
                if (test.equals("true")) {
                    ...
                    if (lang != command.Language.en) return;
                    channel.sendMessage("\u26a0 There is already a country with this name, please select another name").queue();
                    return;
                }
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/member/" + user.getId(), "true", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/pays.txt", "true", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/owner.txt", user.getId(), 1);
                ...
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/bois.txt", "1", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/argile.txt", "1", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/cuir.txt", "1", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/pierre.txt", "1", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/paille.txt", "1", 1);
                TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name2 + "/materiaux/fer.txt", "1", 1);
            ...
            if (lang == command.Language.fr) {
                channel.sendMessage("\ud83c\udf1f Vous devez avoir 10.000.000$ pour creer un pays (1.000.000M$ si premium).").queue();
            }
            if (lang != command.Language.en) return;
        ...
        if (c1.equals("join")) {
            ...
            if (test.equals("true")) {
                String invit = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name + "/member/" + user.getId());
                if (invit.equals("invite")) {
                    data.getProfils().get(user.getId()).setCountry(name);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + name + "/member/" + user.getId(), "true", 1);
                    if (lang == command.Language.fr) {
                ...
                if (lang == command.Language.fr) {
                    channel.sendMessage("\u26a0 Le pays que vous recherchez ne semble pas exister. Veuillez verifier votre orthographe et les majuscules.").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("\u26a0 This country doesn't exist, please checkyour spelling and capitalization.").queue();
            }
            return;
        }
        if (c1.equals("invest")) {
            ...
            try {
                ...
                if (lang == command.Language.fr) {
                    channel.sendMessage("\u26a0 Vous devez indiquer la quantit\u00e9 de ressources \u00e0 donner au pays.").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("\u26a0Please type the quantity of ressources you want to give to your country.").queue();
                return;
            }
            ...
            TextFileWriter.folder("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/");
            int materiau_Pays = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/" + materiau1 + ".txt"));
            ...
            if (pourcentage >= 1.0) {
                if (nombre > materiau_User) {
                    if (lang == command.Language.fr) {
                        channel.sendMessage("\u26a0 Vous ne pouvez pas donner plus de ressources que vous n'en avez.").queue();
                    }
                    if (lang != command.Language.en) return;
                    channel.sendMessage("\u26a0 You can't give more ressources than you have to your country.").queue();
                    return;
                } else {
                    int bonus = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/materiaux/" + materiau1 + ".txt"));
                    int point = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/points.txt"));
                    int point_total = nombre * bonus;
                    int point_total2 = point_total + point;
                    res.put(materiau, materiau_User -= nombre);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/points.txt", Integer.toString(point_total2), 1);
                    TextFileWriter.write("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/ressources/" + materiau1 + ".txt", Integer.toString(materiau_Pays += nombre), 1);
                    ...
                    if (lang == command.Language.fr) {
                        channel.sendMessage(":gift: Vous avez donn\u00e9 *" + nombre + " " + materiau + "* \u00e0 votre pays, ce qui a rapport\u00e9 **" + point_total + " points**.").queue();
                    }
                    if (lang != command.Language.en) return;
                    channel.sendMessage(":gift: You gave *" + nombre + " " + materiau + "* to your country, which brings **" + point_total + "** points to your country.").queue();
                }
                return;
            } else {
                if (lang == command.Language.fr) {
                    channel.sendMessage("\u26a0 Vous devez donner un minimum de 1% des ressources contenu dans les reserve du pays.").queue();
                }
                if (lang != command.Language.en) return;
                channel.sendMessage("\u26a0 You must gave a minimum of 1% of country ressource to the country reserve.").queue();
            }
            return;
        }
        if (lang == command.Language.fr) {
    ...
    public static boolean Bonus(int bonus, String pays) {
        for (int i = 1; i <= 10; ++i) {
            int bonus1;
            TextFileWriter.folder("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine");
            String machine = TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/machine" + i + ".txt");
            if (!machine.equals("active") || bonus != (bonus1 = Integer.parseInt(TextFileWriter.read("/home/DiscordBot/Rasberry/donn\u00e9es/bot/Pays/" + pays + "/machine/bonus" + i + ".txt")))) continue;
            return true;
        }
        return false;
    }
