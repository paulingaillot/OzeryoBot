    ...
    private void onMessage(MessageReceivedEvent event) {
        ...
        if (channel.getId().equals(ChannelCible)) {
            ...
            if (messageNumber == counter + 1 && !event.getAuthor().getId().equals(lastUser)) {
                ...
                if (lang == command.Language.fr) {
                    channelm.setTopic("Total de points : " + messageNumber + " |  1er : " + premier + ", 2e : " + deuxieme + ", 3e : " + troisieme).queue();
                }
                if (lang == command.Language.en) {
                    channelm.setTopic("Total points : " + messageNumber + " |  1st : " + premier + ", 2nd : " + deuxieme + ", 3rd : " + troisieme).queue();
                }
                return;
            }
            if (lang == command.Language.fr) {
